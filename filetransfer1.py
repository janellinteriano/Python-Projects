...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        # creates button to selecr files from source directory
    ...
    def exit_program(self):
        # root is the main GUI window, the Tkinter destry method
        # tells python t terminate root.mainloop and all widgets inside rhe GUI window
        root.destroy()
